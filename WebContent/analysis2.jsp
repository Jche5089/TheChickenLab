...
<%
	Analysis2DTO sales = (Analysis2DTO)session.getAttribute("a2Dto");
    ArrayList<Analysis2DTO> qList = (ArrayList<Analysis2DTO>)session.getAttribute("qua_dto2"); 
...
%>
   ...
   <div id="wrapper">
      ...
      <div id="main">
         <div class="inner">
            ...
            <section id="banner2">
               <div class="content">
                  <header>
                     <h1 class="korean"><%=sales.getHaengjeonggu() %> <%=sales.getHaengjeongdong() %>의 점포수는 <strong style = "color : #e72222;"><%=sales.getChickenNum()%></strong>개 입니다.</h1>
               ...
               <div class="content">
                  <ul class="actions">
                     ...
                     <li><a href="analysis2.jsp" class="button big sd2 sd1">지역(배후지)분석</a></li>
      ...
      <!-- Banner -->
            <section id="banner">
               <div class="con">
                  <h1 class="korean">○<strong> <%=sales.getHaengjeonggu() %> 식당수 TOP5 </strong></h1><br><br>
                  <br>
                  <!--  그래프 -->
                  <div class= "graph">
                  ...
                  <div class="graphText div2">
                     ...
                     "선택한 <strong style = "color : #e72222;"><%=sales.getHaengjeongdong() %></strong>의 식당수는 <strong style = "color : #e72222;"><%=sales.getBistroNum()%></strong>개이며, 인근 행정동 평균대비 주변 식당수가 
                     <%if(sales.getIstroPm() > 0){
                     
                     %>
                        <strong style = "color : #e72222;"><%=sales.getIstroPm() %>%</strong> 많습니다."   
                           
                     <%}else if(sales.getIstroPm() < 0){ %>   
                        <strong style = "color : #e72222;"><%=sales.getIstroPm() %>%</strong> 적습니다."   
                     <% }else{%>
                  ...
                  <table class="styled-table table">
                     <thead>
                        <tr>
                           <td rowspan="2">구분</td>
                           <td colspan="5"><%=qList.get(0).getHaengjeonggu() %> 식당수 TOP5</td>   
                        </tr>
                      </thead>
                      <tbody>
                      <%
                         ...
                         for(int i=0; i<qList.size();i++){
                            count[i] = qList.get(i).getBistroNum();;
      ...
      <!-- Banner -->
            <section id="banner">
               <div class="con">
                  <h1 class="korean">○<strong> <%=sales.getHaengjeonggu() %> 집객시설수 TOP5 </strong></h1><br><br>
                  <br>
                  <!--  그래프 -->
                  <div class= "graph">
                  ...
                  <div class="graphText div2">
                     ...
                     "선택한 <strong style = "color : #e72222;"><%=sales.getHaengjeongdong() %></strong>의 집객시설수는 <strong style = "color : #e72222;"><%=sales.getFacilityNum()%></strong>개이며, 인근 행정동 평균대비 주변 집계시설수가  
                     <%if(sales.getFacilityPm() > 0){
                     
                     %>
                        <strong style = "color : #e72222;"><%=sales.getFacilityPm() %>%</strong> 많습니다."   
                           
                     <%}else if(sales.getFacilityPm() < 0){ %>   
                        <strong style = "color : #e72222;"><%=sales.getFacilityPm() %>%</strong> 적습니다."   
                     <% }else{%>
                        <strong style = "color : #e72222;">평균</strong>에 속합니다.   
                     <% }%>
                  ...
                  <table class="styled-table table">
                     <thead>
                        <tr>
                           <td rowspan="2">구분</td>
                           <td colspan="5"><%=sales.getHaengjeonggu() %> 집계시설수 TOP5</td>   
                        </tr>
                      </thead>
                      <tbody>
                      ...
                      <%
                         ...
                         for(int i=0; i<qList.size();i++){
                            count2[i] = qList.get(i).getFacilityNum();
